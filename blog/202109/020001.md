...
```
定义：priority_queue<elemtype> pri_que;（默认为大根堆，如果要小根堆：priority_queue<elemtype, vector<elemtype>, greater<elemtype>> pri_que;）
...
下面的有比较函数的lower_bound/upper_bound一般要和有比较函数的sort配合使用：
